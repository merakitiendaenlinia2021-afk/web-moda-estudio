/* PRODUCTS.JS — FASE 2: + barra de anuncios visible/oculta, navegación editable */
...
window.PRODUCTS = [
  ...
  { id:"blaze", name:"Short Blaze — Negro", collection:"horizon", price:249900, oldPrice:null, tag:null, images:["https://picsum.photos/seed/p3/600/750?grayscale","https://picsum.photos/seed/p3b/600/750?grayscale"], shortDescription:"Short técnico.", longDescription:"Para deportistas y aventureros.", colors:["#0A0A0A","#3A4D3A"], sizes:["S","M","L"], sku:"BLZ-003", active:true },
  { id:"drift", name:"Pantalón Drift — Cargo técnico", collection:"horizon", price:429900, oldPrice:null, tag:"bestseller", images:["https://picsum.photos/seed/p4/600/750?grayscale","https://picsum.photos/seed/p4b/600/750?grayscale"], shortDescription:"Pantalón cargo.", longDescription:"Urbano-outdoor con múltiples bolsillos.", colors:["#0A0A0A","#5C5045","#2B3329"], sizes:["28","30","32","34","36"], sku:"DRF-004", active:true },
